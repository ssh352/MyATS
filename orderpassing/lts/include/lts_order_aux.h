#ifndef __LTS_ORDER_H__
#define __LTS_ORDER_H__
...
namespace lts
{
	...
	{
	public:
		//lts_order(lts_connection* pConnection);
		//virtual ~lts_order() {}


		static order* anchor(lts_connection* pConnection, CSecurityFtdcInputOrderField* pOrder);
		static order* anchor(lts_connection* pConnection, CSecurityFtdcOrderField* pOrder);
		static order* anchor(lts_connection* pConnection, CSecurityFtdcTradeField* pTrade, bool isETFSotck = false);
