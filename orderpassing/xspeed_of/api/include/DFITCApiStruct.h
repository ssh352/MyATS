...
struct APISTRUCT DFITCArbitrageCombineDetailRtnField
{
    ...
    DFITCBuySellTypeType                buySellType;                  //买卖
    DFITCPriceType                      openPrice;                    //开仓价
    DFITCInstrumentIDType               comTradeID;                   //组合编号
    DFITCDateType                       openDate;                     //开仓日期
    DFITCMatchIDType                    matchID;                      //成交编号/结算编号
    DFITCAmountType                     volume;                       //持仓数量
    DFITCAmountType                     tradingAmount;                //挂单数量
    DFITCProfitLossType                 margin;                       //保证金
    DFITCSpeculatorType                 speculator;                   //投保类别
    DFITCInstrumentTypeType             instrumentType;               //合约类型
    DFITCSPDOrderIDType                 spdOrderID;                   //柜台委托号
    DFITCCustomCategoryType             customCategory;               //自定义类别
