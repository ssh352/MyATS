#ifndef __LTS_TRDAPI_FILE_H__
#define __LTS_TRDAPI_FILE_H__
...
namespace lts_file
{
   ...
   class lts_file_trdapi :/*public RTThread,*/ public CSecurityFtdcTraderSpiBase//CSecurityFtdcTraderSpi
   {
   ...
   public:
	   lts_file_trdapi();
	   lts_file_trdapi(lts_file_connection* pConnection);
	   virtual ~lts_file_trdapi();
